...
const restaurant = {
  ...
  //SE6 enhanced object literals
  openingHours,

  //SE6 enhanced object literals - get rid of the function keyword and the semicolon
...
// console.log(restaurant.openingHours.mon.open); // error message - cannot read properties of undefined
...
const users = [{ name: 'Steven', email: 'danielsteven.ds@gmail.com' }];
